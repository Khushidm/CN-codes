# CN-codes
Programs and implementation of data structures in java (as per JSSTU syllabus)
PART A
1 A. Use appropriate tool to find Host name, IP address, physical address, 
...
4 Write a program to find the shortest path between vertices using bellman
ford algorithm. 
...
9 Write a program to implement random early detection (RED) congestion 
control algorithm. 
